...
\begin{document}
  ...
  \section{Asymptotics}
    ...
    \begin{corollary}\label{equ:weaker_Stirling_formula_2}
      Suppose \(\s_{1} \le \s \le \s_{2}\) and that \(s\) is at least distance \(\e\) away from the poles of the gamma function in this vertical strip. Then
      \[
    ...
    \begin{proof}
      ...
      \]
      Since the gamma function is holomorphic and bounded on the compact set defined by \(\s_{1} \le \s \le \s_{2}\) and \(|t| \le \e\) with \(s\) at least distance \(\e\) away from its poles, we may relax the condition \(|t| \ge 1\) provided we replace \(|t|\) with \(|t|+3\). This proves the first two estimates. The third estimate is obtained by taking the ratio of these two.
    \end{proof}
    ...
    \begin{corollary}\label{equ:weaker_approximtion_for_digamma_2}
      Suppose \(\s_{1} \le \s \le \s_{2}\) and \(s\) is at least distance \(\e\) away from the poles of the digamma function in this vertical strip. Then
      \[
    ...
    \begin{proof}
      ...
      \]
      Since the digamma function is holomorphic and bounded on the compact set defined by \(\s_{1} \le \s \le \s_{2}\) and \(|t| \le \e\) with \(s\) at least distance \(\e\) away from its poles, we may relax the condition \(|t| \ge 1\) provided we replace \(|s|\) with \(|s|+3\). The estimate follows.
    \end{proof}
